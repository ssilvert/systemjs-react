(function (global) {
  System.config({
    ...
    map: {
      ...
      '@patternfly/react-styles/css': 'npm:@patternfly/react-styles/css',
    ...
    packages: {
      ...
      'npm:@patternfly/react-styles/css': {
          defaultExtension: 'js',
          map: {
            './components/Button/button.css': '@empty',
            './components/NotificationBadge/notification-badge.css': '@empty',
            './components/Tabs/tabs.css': '@empty',
            './layouts/Flex/flex.css': '@empty',
            './layouts/Stack/stack.css': '@empty',
          }
      },
      'npm:no-case/vendor': {
          defaultExtension: 'js',
